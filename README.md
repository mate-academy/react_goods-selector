...
1. Show the `ClearButton` button in the title only when a good 
 selected.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://daryna-hnidash.github.io/react_goods-selector/) and add it to the PR description.
