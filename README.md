...
1. Save a `hasGood` in the state (`Jam` is the default value).
...
1. `ClearButton` should clear selection by setting an empty string to `hasGood`.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://rodionsav.github.io/react_goods-selector/) and add it to the PR description.
