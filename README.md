...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vova-myronenko.github.io/react_goods-selector/)
...
1. Add button `X` to the `h1` to clear the selection. (Set `null`)
