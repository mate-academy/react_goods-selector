...
1. Add the `has-background-success-light` class to the `tr` of the selected Good. //done
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://maksym-bobryk.github.io/react_goods-selector/) and add it to the PR description.
