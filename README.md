...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Rozdorozhnii.github.io/react_goods-selector/)
...
1. Save a `selectedGood` in the `App`. Let it beby default
