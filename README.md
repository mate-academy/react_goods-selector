...
1. Save a `selectedGood` in the state (`Jam` is the default value). // done
...
1. `ClearButton` should clear selection by setting an empty string to `selectedGood`. // done 
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://milenadiamonds1.github.io/react_goods-selector/) and add it to the PR description.
